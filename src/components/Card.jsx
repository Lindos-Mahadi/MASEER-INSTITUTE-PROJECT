                                        ...
                                        <Card>
                                            <Card.Header className="bg-success">
                                                <Accordion.Toggle as={Button} variant="link" eventKey="3">
                                                    <h6 className="text-white text-decoration-underline">Reade More</h6>
                                                </Accordion.Toggle>
                                            </Card.Header>
                                ...
                                <Card>
                                    <Card.Header className="bg-success">
                                        <Accordion.Toggle as={Button} variant="link" eventKey="0">
                                            <h6 className="text-white text-decoration-underlline">Why Learn the Arabic Language?</h6>
                                        </Accordion.Toggle>
                                    </Card.Header>
                                ...
                                <Card>
                                    <Card.Header>
                                        <Accordion.Toggle as={Button} variant="link" eventKey="1">
                                            <h6 className="text-white text-decoration-underline"> Learning Arabic-where do I start? </h6>
                                        </Accordion.Toggle>
                                    </Card.Header>
                                ...
                                <Card>
                                    <Card.Header className="bg-success">
                                        <Accordion.Toggle as={Button} variant="link" eventKey="2">
                                            <h6 className="text-white text-decoration-underline">Learn Arabic Fast</h6>
                                        </Accordion.Toggle>
                                    </Card.Header>
