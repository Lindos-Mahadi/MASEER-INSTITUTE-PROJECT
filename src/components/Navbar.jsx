                          ...
                          <Navbar.Collapse id="responsive-navbar-nav" className="navbar">
                              <Nav className="ml-auto">
                                  <Nav.Item className="nav-item mt-sm-5 mt-md-0">
                                      <Nav.Link className="nav-link first-item" href="/">Home</Nav.Link>
                                  </Nav.Item>
                                  <Nav.Item >
                                      <Nav.Link className="nav-link" href="/course">Courses</Nav.Link>
                                  </Nav.Item>
                                  <Nav.Item>
                                      <Nav.Link className="nav-Link enrollCourse" href="/enrollments">Enrollment</Nav.Link>
                                  </Nav.Item>
                                  <Nav.Item>
